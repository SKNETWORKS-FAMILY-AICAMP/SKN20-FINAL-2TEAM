...
Usage:
    ...
    python -m v1.rag.eval.interactive_test --verbose
...
from v1.rag.search.multi_query import extract_components
from v1.rag.eval.evaluate import evaluate, load_test_dataset
...
def run_repl(verbose: bool = False):
    ...
    while True:
        ...
        for i, r in enumerate(results):
            ...
            print(f"  {i+1:<4} {pid:<20} {score:<10.6f} {claim:<6} {title}{est_mark}")
