"""Qwen2.5 3B 파인튜닝 스크립트 (sllm_qwen_data 기반).
...
logger.add(
    LOG_DIR / "train_qwen3b_{time:YYYY-MM-DD_HH-mm-ss}.log",
    level="DEBUG",
    rotation="100 MB",
    encoding="utf-8",
)
...
OUTPUT_DIR = str(BASE_DIR / "outputs" / "qwen2.5-3b-lora")
...
def main():
    parser = argparse.ArgumentParser(description="Qwen2.5 3B 파인튜닝 (sllm_qwen_data)")
    ...
    parser.add_argument("--resume_from_checkpoint", type=str, default=None, help="체크포인트 경로 (재시작 시)")
