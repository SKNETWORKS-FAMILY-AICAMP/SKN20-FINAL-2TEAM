"""Qwen2.5 7B 파인튜닝 스크립트 (sllm_qwen_data 기반).

사용법:
    cd /workspace/SKN20-FINAL-2TEAM
    python -m SLLM_model.training.train_qwen_7b
...
logger.add(
    LOG_DIR / "train_qwen_7b_{time:YYYY-MM-DD_HH-mm-ss}.log",
    level="DEBUG",
    rotation="100 MB",
    encoding="utf-8",
)
...
OUTPUT_DIR = str(BASE_DIR / "outputs" / "qwen2.5-7b")
...
def main():
    parser = argparse.ArgumentParser(description="Qwen2.5 7B 파인튜닝 (sllm_qwen_data)")
